...
if(empty($_SESSION['user']['user_id'])) {
  ...
  $session = $_SESSION['user']['user_name'];
...
<head>
    ...
    <link rel="stylesheet" href="Your service.php">
</head>
<body>
	<header>
     <a href="#" class="logo">WELCOME<br>
     ...
     if ($_SESSION['user']['user_type'] == 'admin') {
         ?>
                <ul>
                <li ><a href="admin/home.php">ADMIN PANNEL</a></li>
            ...
            ?>
                <ul>
                <li ><a class="active" href="Your service.php">SERVICE</a></li>
                <li ><a href="contact us.php"> CONTACT</a></li>
                <li ><a href="corps entrance.php">CORPS ENTRANCE</a></li>
                <li ><a href="recuitment.php"> RECRUITMENT</a></li>
                <li ><a href="index.php">USER PANNEL</a></li>
                <li><a href="index.php?logout='1'">LOGOUT</a></li>
                </ul>
            <?php
            }
     ...
     <section class="banner">
        <div class="slideshow-item">
            <img src="images2/pronew.jpg">
            <div class="slideshow-item-text">
            </div>
        </div>
        <div class="slideshow-item">
            <img src="images2/pro31.jfif">
            <div class="slideshow-item-text">
            </div>
        </div><div class="slideshow-item">
            <img src="images2/pro40.jfif">
            <div class="slideshow-item-text">
            </div>
        </div>
     </section>
...
<div class="About-img"><img src="images2/pro39.jfif"></div>
     </div>
